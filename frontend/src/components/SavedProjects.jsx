  ...
  return (
    <div className="glass-card p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
      ...
      <div className="flex items-center gap-3 mb-5">
        <div className="w-10 h-10 rounded-xl bg-surface-700/50 border border-surface-600/40 flex items-center justify-center">
...
function ProjectItem({ project, onDownload, onResume, onDelete, isDownloading }) {
  ...
  return (
    <div className="group bg-surface-900/40 border border-surface-700/30 rounded-xl p-4 flex items-center justify-between hover:bg-surface-800/60 hover:border-surface-600/40 transition-all duration-200">
      {/* Info */}
