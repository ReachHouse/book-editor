 ...
 * VERSION HISTORY:
 * ----------------
 * v1.41.1 [Bugfix]   - 2026-02-05: Fix SetupWizard browser autofill bug — use refs to read actual DOM values on submit, handles cases where browser autofill populates fields without triggering React onChange events (452 total)
